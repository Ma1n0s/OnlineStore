...
<template>
    <div class="container mx-auto px-4 md:px-6 lg:px-8 py-8">
        ...
        <div>
            <h2 class="font-bold text-2xl">Бесщеточный аккумуляторный шуруповерт KEYANG DD18BL-W (Set)</h2>
        </div>
        <div class="flex">
            <img src="" alt="" class=""/>
        </div>
        <div class="flex">
            <p>Код товара: 24955389</p>
            <img />
            <p>14 отзывов |5 вопросов</p>
            <img />
        ...
        <div class="flex space-x-8 p-8">
            ...
            <div class="w-1/4 bg-white border rounded-lg p-4 shadow-md">
                <h2 class="text-xl font-bold text-gray-800">Сезон впереди</h2>
                <div class="flex justify-between mt-2">
                    <span class="line-through text-gray-500">23 990 ₽</span>
                    <span class="text-green-600">Выгода 2 000 ₽</span>
                </div>
                <h2 class="text-2xl font-bold text-red-600">21 990 ₽</h2>
                <div class="mt-4">
                    <span>5498 ₽ x 4 платежа в рассрочку</span>
                </div>
                <button class="mt-4 w-full bg-red-500 text-white py-2 rounded">В корзину</button>
                <button class="mt-4 w-full bg-red-500 text-white py-2 rounded">Быстрый заказ</button>
                <div class="mt-4">
        ...
        <div class="border-b">
            ...
            <div class="spacer"></div> <!-- Пробел для прокрутки -->
            ...
            <div id="product-card" class="hidden flex items-center justify-between p-4 border shadow-md bg-white">
                ...
                <div class="text-right">
                    ...
                    <button class="mt-2 bg-red-600 text-white px-4 py-2 rounded">В корзину</button>
                </div>
            </div>
