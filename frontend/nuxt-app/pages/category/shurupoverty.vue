  ...
  items: [
    {
      ...
      image: "/images/products/ryobi-drill.jpg",
      price: 13290,
      oldPrice: 15990,
      discount: 17,
      stock: 100,
    ...
    },
    {
      ...
      image: "/images/products/makita-drill.jpg",
      price: 15290,
      oldPrice: 17990,
      discount: 15,
      stock: 30,
    ...
    },
    {
      ...
      image: "/images/products/dewalt-drill.jpg",
      price: 18990,
      oldPrice: 21990,
      discount: 14,
      stock: 25,
    ...
    },
    {
      ...
      image: "/images/products/metabo-drill.jpg",
      price: 16290,
      oldPrice: 18990,
      discount: 14,
      stock: 20,
    ...
    },
    {
      ...
      image: "/images/products/hitachi-drill.jpg",
      price: 13990,
      oldPrice: 16990,
      discount: 18,
      stock: 15,
    ...
    },
    {
      ...
      image: "/images/products/aeg-drill.jpg",
      price: 14990,
      oldPrice: 17990,
      discount: 17,
      stock: 10,
    ...
    },
    {
      ...
      image: "/images/products/black-decker-drill.jpg",
      price: 8990,
      oldPrice: 11990,
      discount: 25,
      stock: 40,
...
const filteredItems = computed(() => {
  return state.items.filter((item) => {
    const priceMatch = item.price >= state.priceRange.currentMin && 
                      item.price <= state.priceRange.currentMax;
    const brandMatch = state.filters.selectedBrands.length === 0 || 
                      state.filters.selectedBrands.includes(item.brand);
    ...
    const newItems = [
      {
        ...
        image: "/images/products/hilti-drill.jpg",
        price: 24990,
        oldPrice: 28990,
        discount: 14,
        stock: 5,
      ...
      },
      {
        ...
        image: "/images/products/milwaukee-drill.jpg",
        price: 21990,
        oldPrice: 25990,
        discount: 15,
        stock: 8,
  ...
  <div class="container mx-auto px-4 md:px-6 lg:px-8 py-6">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 mb-8">
      <div v-for="i in 4" :key="i" class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow border border-gray-100 overflow-hidden group">
        <div class="p-4">
          ...
          <NuxtImg
            src="/images/categories/drills.jpg"
            alt="Шуруповерты"
    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between bg-white rounded-lg shadow-sm p-4 mb-6">
      ...
      <div class="flex items-center space-x-4">
        ...
        <div class="flex items-center space-x-1">
          <button @click="showGrid" :class="{'bg-gray-100 text-red-600': state.ui.isGrid}" class="p-2 rounded-lg hover:bg-gray-100 transition-colors">
            <NuxtImg
    ...
    <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div class="px-2">
              <div class="relative h-8">
                ...
                <div
                  ...
                  :style="{
                    left: `${((state.priceRange.currentMin - state.priceRange.min) / (state.priceRange.max - state.priceRange.min)) * 100}%`,
                    width: `${((state.priceRange.currentMax - state.priceRange.currentMin) / (state.priceRange.max - state.priceRange.min)) * 100}%`,
                  }"
                ></div>
                <input
                  type="range"
      ...
      <div class="w-full lg:w-3/4">
        <div v-if="filteredItems.length > 0" :class="state.ui.isGrid ? 'grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5' : 'space-y-5'">
          <div
            v-for="item in visibleItems"
            :key="item.id"
            :class="state.ui.isGrid ? 'bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow border border-gray-100 overflow-hidden flex flex-col h-full' : 'bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow border border-gray-100 overflow-hidden flex'"
          >
            ...
            <div :class="state.ui.isGrid ? 'p-4 flex flex-col flex-grow' : 'w-2/3 p-4 flex flex-col'">
              ...
              <NuxtLink to="/product/productCard" class="block">
                <h3 class="font-medium text-gray-900 hover:text-red-600 transition-colors line-clamp-2 mb-2 min-h-[2.5rem]">{{ item.title }}</h3>
              </NuxtLink>
        ...
        <!-- Кнопка "Показать еще" -->
        <div class="flex justify-center mt-8" v-if="state.ui.visibleItems < filteredItems.length && filteredItems.length > 0">
          <button 
            @click="loadMoreItems" 
          ...
          >
            ...
            <div v-if="state.ui.isLoading" class="animate-spin -ml-1 mr-2 h-5 w-5 text-red-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
              4444444444
            </div>
          </button>
        </div>
