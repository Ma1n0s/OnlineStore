          ...
          <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <div class="flex items-start gap-4">
              <div class="relative flex-shrink-0">
                <div class="w-14 h-14 rounded-full bg-gradient-to-tr from-blue-100 to-purple-200 flex items-center justify-center overflow-hidden">
              ...
              <div class="flex-1 min-w-0">
                <div class="flex items-baseline gap-2 flex-wrap">
                  <h1 class="text-2xl font-bold text-gray-900 truncate">{{ profile.lastname }} {{ profile.firstname }} {{ profile.middlename }}</h1>
                </div>
                ...
                <div v-if="profile.companyDetails" class="mt-3">
                  ...
                  >
                    <div 
                      ...
                      class="bg-gray-50 p-4 rounded-b-lg border-t border-gray-200 mt-0"
                    >
            ...
            <div class="border-t pt-4">
              ...
              <div class="space-y-4">
                ...
                <div class="flex flex-wrap gap-4 pt-2">
                  ...
                  <button class="text-blue-600 hover:text-blue-700 text-sm font-medium flex items-center gap-2 transition">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
