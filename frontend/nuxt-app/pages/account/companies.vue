        ...
        <div class="flex-1 space-y-4 md:space-y-6">
              ...
              <div class="p-4 md:p-6">
                <div class="flex justify-between items-start mb-3 md:mb-4 flex-wrap gap-2">
                  <h3 class="text-base md:text-lg font-medium text-gray-900">
                    ...
                    <span v-if="company.is_main" class="ml-1 md:ml-2 text-xs bg-primary text-white px-1.5 py-0.5 md:px-2 md:py-1 rounded"
                      >Основная</span
                    >
                  </h3>
          ...
          >
            <div class="p-4 md:p-6 text-center py-8 md:py-12">
              ...
              <p class="text-gray-500 text-sm md:text-base mb-4 md:mb-6">Добавьте информацию о вашей компании для работы с документами</p>
              <button
                @click="startAdding"
                  ...
                  <div>
                    ...
                    <div class="space-y-3 md:space-y-4">
                      <div>
                        ...
                        <p v-if="innError && !form.errors.inn" class="mt-1 text-xs md:text-sm text-red-600">{{ innError }}</p>

                        <div v-if="isLoadingSuggestions" class="mt-2 flex items-center text-gray-500 text-xs md:text-sm">
                      ...
                      <template v-if="uiState.showFullForm">
                        <div>
                          ...
                          <input
                            ...
                            class="w-full px-3 py-1.5 md:px-4 md:py-2 border rounded-lg shadow-sm focus:ring-primary focus:border-primary text-sm md:text-base"
                          />
                          <p v-if="form.errors.name" class="mt-1 text-xs md:text-sm text-red-600">{{ form.errors.name }}</p>
                        </div>
