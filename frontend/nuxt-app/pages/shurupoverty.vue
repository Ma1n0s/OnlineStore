...
const filteredItems = () => {
  return items.value.filter((item) => item.price >= minPrice.value && item.price <= maxPrice.value);
};
</script>
...
<template>
  ...
  <div class="container mx-auto px-4 md:px-6 lg:px-8 py-8">
    <nav class="flex space-x-2 text-gray-600 mb-4">
      ...
      <p>/</p>
      <NuxtLink to="/category/troitelnyj-instrument" class="font-semibold">Инструменты</NuxtLink>
      <p>/</p>
    ...
    <div class="flex gap-4 mt-4">
      <div
        class="bg-gray-100 flex flex-col space-y-2 justify-between rounded-lg p-4 w-52 h-full hover:bg-gray-300 transition duration-200 ease-in-out shadow-md"
      >
      ...
      <div class="w-1/4 pr-4">
        ...
        <div class="mb-4">
          ...
          <div class="flex flex-col items-center">
            ...
            <button class="text-white bg-red-600 rounded-2xl p-2 text-sm h-10 hover:bg-red-700">
              Показать 5 185 товаров
            </button>
          </div>
          <div>
            ...
            <transition name="slide">
              <div v-if="showFilters" class="fixed inset-y-0 left-0 w-64 bg-white z-50 p-4 overflow-y-auto shadow-lg">
                <button
                  @click="toggleFilters"
        ...
        <div :class="isGrid ? 'grid grid-cols-4 gap-4' : 'flex flex-col space-y-4'">
          ...
          >
            <div class="p-4">
              ...
              <NuxtLink to="/product/productCard"
                ><h3 class="mt-2 text-xl font-semibold hover:text-rose-600">{{ item.title }}</h3></NuxtLink
              >
