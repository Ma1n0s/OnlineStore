<template>
	<div class="bg-white rounded-xl p-4 sm:p-6 mb-4 sm:mb-6 shadow-sm">
		...
		<div v-if="rentedItems.length > 0">
			<div class="divide-y divide-gray-200 rounded-lg">
				<div
					v-for="item in rentedItems"
					:key="'rented-' + item.id"
					class="sm:py-4 px-3 sm:px-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 bg-gray-50 hover:bg-gray-100"
				>
					<div class="flex items-start sm:items-center gap-3 sm:gap-4">
						...
						<div class="flex-1 min-w-0">
							...
							<div class="flex items-center gap-2 mt-1">
								<span class="text-xs sm:text-sm bg-blue-100 text-blue-800 px-2 py-1 rounded">
...
// Separate items into different types
