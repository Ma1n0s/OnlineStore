<template>
  <div class="container mx-auto px-4 py-8">
    <nav class="flex space-x-4 text-gray-600 mb-4">
      ...
      <RouterLink to="#" class="hover:underline">Личный кабинет</RouterLink>
    ...
    <div class="flex flex-col items-center">
      <div class="w-24 h-24 mb-4">
        <img
          src="https://upload.wikimedia.org/wikipedia/commons/4/4c/Heart_icon_red.svg"
          alt="Heart icon"
          class="w-full h-full"
        />
      </div>
      ...
      <RouterLink to="#" class="bg-red-500 text-white py-2 px-4 rounded hover:bg-red-600"
